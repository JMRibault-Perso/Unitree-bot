...
Standalone version - no imports from g1_app to avoid robot controller
"""

from enum import IntEnum

# Define FSMState locally
class FSMState(IntEnum):
    """FSM States - copied from constants.py"""
    ZERO_TORQUE = 0
    DAMP = 1
    SQUAT = 2
    SIT = 3
...
# Define transitions - copied from state_machine.py
TRANSITIONS = {
...
def main():
    print("\n" + "="*80)
    print("STATE MACHINE MOCK TEST - Standalone Version")
    print("="*80)
    ...
    # Test from START
    test_state_transitions(FSMState.START)
